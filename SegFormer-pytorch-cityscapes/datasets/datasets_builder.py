...
from datasets.datasets_samplers_distributed_sampler import DistributedSampler
...
def _concat_dataset(cfg, default_args=None):
    ...
    from datasets.datasets_dataset_wrappers import ConcatDataset
...
def build_dataset(cfg, default_args=None):
    """Build datasets."""
    from datasets.datasets_dataset_wrappers import (
        ConcatDataset,
